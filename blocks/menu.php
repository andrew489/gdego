...
?>
<div id="dropdown-menu" class="border-0 collapse text-100 pt-3">
    <div class="row">
...
<? $submenu = array_filter($arrays,function ($a){return isset($a['submenu']);});
    foreach($submenu as $array){?>
        <div id="submenu<?=$array['id']?>" class="submenu border-0 collapse text-100 pt-3  pb-3" style="background: linear-gradient(0deg, #FCFAF7, #FCFAF7);border-radius: 4px;">
            <div class="row">
